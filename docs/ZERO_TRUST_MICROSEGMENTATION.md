...
## Network Architecture & Egress Principles

To guarantee that Omarchy workstations report continuous telemetry to corporate SOC clouds without exposing the workstation to local network threats:
